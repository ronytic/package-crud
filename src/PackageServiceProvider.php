...
namespace ProcessMaker\Package\PackageCrud;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PackageCrud\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PackageCrud\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PackageCrud\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'package-crud');

        $this->publishes([
            __DIR__ . '/../public' => public_path('vendor/processmaker/packages/package-crud'),
        ], 'package-crud');
