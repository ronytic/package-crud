...
searchDirectoryFiles(getcwd() . '/', 'package-crud', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageCrud', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Crud', dashesToCamelCase($argv[1], true, ' '));
